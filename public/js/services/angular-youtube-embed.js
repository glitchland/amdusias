/* global YT */
/* This service is taken from :
 * https://github.com/alexthewilde/angular-youtube-embed
 * Added some functionality to not destroy player on video change
 */
        ...
        return {
            ...
            link: function(scope, element, attrs) {
                ...
                function loadPlayer() {
                    ...
                    if (scope.player && !isEmpty(scope.player) && scope.player.getIframe() && (typeof scope.player.cueVideoById === 'function')) {
                    ...
                    // Otherwise, create a new player
                        ...
                        console.log("AngularYoutube Creating New Player");
                        scope.player = createPlayer();
                    }
                }

                var stopWatchingReady = scope.$watch(
                    function() { // Wait until one of them is defined...
